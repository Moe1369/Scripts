# Basically Disassemblers Win10-Initial-Setup-Script all-in-one with some changes and additions
...
# Disable tracking App Launches
Function DisableAppLaunchTracking {
Write-Output "Disabling Applaunch Tracking..."
Set-ItemProperty -Path "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced" -Name "Start_TrackProgs" -Type DWord -Value 0
}
# Enable tracking App Launches
...
# Set gray inactive title bar color
Function SetInactiveTitleBarColor {
	Write-Output "Set inactive window title bar color..."
	Set-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\DWM" -Name "AccentColorInactive" -Type DWord -Value 14606046
}

Function UnsetInactiveTitleBarColor {
	Write-Output "Unset inactive window title bar color..."
	Remove-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\DWM" -Name "AccentColorInactive" -ErrorAction SilentlyContinue
	}
...
Function EnableXboxFeatures {
	...
	Get-AppxPackage -AllUsers "Microsoft.XboxGameCallableUI" | ForEach-Object {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"}
...
##########
#region Microsoft Office Tweaks
##########

# Disable signing in to Office
Function DisableSignIn {
	Write-Output "Disable signing in to Office..."
	If (!(Test-Path "HKCU:\software\policies\microsoft\office\16.0\common\signin")) {
		New-Item -Path "HKCU:\software\policies\microsoft\office\16.0\common\signin" -Force | Out-Null
	}
	Set-ItemProperty -Path "HKCU:\software\policies\microsoft\office\16.0\common\signin" -Name "signinoptions" -Type DWord -Value 3
}

# Enable signing in to Office
Function EnableSignIn {
	Write-Output "Enable signing in to Office..."
	Remove-ItemProperty -Path "HKCU:\software\policies\microsoft\office\16.0\common\signin" -Name "signingoptions" -ErrorAction SilentlyContinue
}

##########
#endregion Microsoft Office Tweaks
##########
